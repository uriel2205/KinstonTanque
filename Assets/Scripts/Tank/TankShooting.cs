...
public class TankShooting : MonoBehaviour
{
 ...
 private bool m_Fired; //Booleano que comprueba si se ha lanzado la bomba
    ...
    private void Fire()
    {
        ...
        m_Fired = true;
        // Creo una instancia de la bomba y guardo una referencia en su Rigidb ody.
        ...
        m_ShootingAudio.Play();
        //Reseteo la fuerza de lanzamiento como precaución ante posibles event os de botón "perdidos".
         m_CurrentLaunchForce = m_MinLaunchForce;
    }
}